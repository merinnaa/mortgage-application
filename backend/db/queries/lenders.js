...
const createNewLender = (first_name,last_name,email,bcryptPassword,institution,employee_id,role) => {
  return db.query("INSERT INTO users (first_name,last_name,email, password, institution, employee_id, role) VALUES ($1, $2 , $3,$4,$5,$6,$7) RETURNING *;",[first_name,last_name, email, bcryptPassword,institution,employee_id,role] )
