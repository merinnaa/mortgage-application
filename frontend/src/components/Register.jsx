...
const Register = ({ setAuth }) => {
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://mortgage-application-server.vercel.app/auth/register",
        {
          method: "POST",
        ...
        >
          <div className="self-stretch flex flex-col justify-start items-start gap-12">
            <div className="self-stretch flex flex-col justify-start items-center gap-4">
              <div className="self-stretch text-center justify-start text-zinc-800 text-2xl font-bold font-['Inter'] leading-9 tracking-tight">
                Sign up
              </div>
              <div className="self-stretch text-center justify-start">
                <span class="text-zinc-800 text-base font-normal font-['Inter'] leading-normal">
                  Already have an account?{" "}
                </span>
                <Link
                  to={"/login"}
                  class="text-teal-500 text-base font-bold font-['Inter'] leading-normal"
                >
                  Log in
                </Link>
              </div>
  ...
  `}
                ...
                {errors.firstName && (
                  <div className="self-stretch h-6 justify-start text-orange-600 text-base font-normal font-['Inter'] leading-normal">
                    {errors.firstName}
                  </div>
                )}
              </div>
